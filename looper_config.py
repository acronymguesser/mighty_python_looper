from looper.playback_definitions import FileLoopPlaybackDefinition, RecordLoopPlaybackDefinition, FileSinglePlaybackDefinition
...
def get_playback_definition_list():
  return [
    FileSinglePlaybackDefinition('338\drums_bass.wav', play_from=0, play_at=0, play_times=99)
